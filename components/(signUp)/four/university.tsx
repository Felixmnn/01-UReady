...
const University = ({
  ...
  return (
    <View className="h-full  w-full justify-between items-center py-5">
      ...
      <View
        className="flex-1 bg-gray-900 w-full  max-w-[600px] max-h-[700px] rounded-[10px] "
      ...
      >
        ...
        <View className="flex-1">
          <FlatList
            data={universityListDeutschland.filter((item: { name: string }) =>
              item.name.toLowerCase().includes(universityFilter.toLowerCase())
            )}
              ...
              <View className="items-center justify-center flex-1">
                <Text className="text-gray-400 font-semibold text-center">
                  {universityFilter.length > 0
                    ? t("personalizeFour.noUniversityFound")
                    : t("personalizeFour.noUniversityAvailable")}
                </Text>
              </View>
            )}
            renderItem={({ item }) => (
              ...
              >
                ...
                />
                <Text
                  className="text-gray-100 font-semibold text-[15px] text-center ml-2"
