...
export async function updateModuleData (id, data) {
    console.log("🔷updateModuleData", id, data)
    try {
        const res = await databases.updateDocument(
            config.databaseId,
...
export async function updateUserUsageData (data) {
    console.log("🔷updateUserUsageData", data)
    try {
        const res = await databases.updateDocument(
            config.databaseId,
...
export async function updateUserUsageSessions(id, newSession) {
    console.log("🔷updateUserUsageSessions", id, newSession)
    try {
        const oldUserUsage = await loadUserUsage(id);
        console.log("🔷oldUserUsage", oldUserUsage)
