  ...
  return (
    <View className='flex-1 bg-[#0c111d] rounded-[10px]'>
        ...
        <View className={`w-full ${isVertical ? "flex-row": "flex-1 w-full"}`}>
            <Karteikarte handlePress={()=> setSelected("SingleModule")} farbe={"#06aed4"} titel={"Algorythmen"} studiengang={"Informatik"} fragenAnzahl={21} notizAnzahl={1} creator={"YOU"} availability={false} icon={"clock"}/>
