    ...
    useEffect(() => { 
        async function fetchQuestions() {
            ...
            if (notes) {
                ...
                const filteredNotes = noteArray.filter((note) => note.subjectID == module.documents[selectedModule].$id);
            ...
            <View className='flex-1 w-full bg-gray-900 rounded-[10px] border-gray-700 border-[1px]'>
                ...
                <View className='flex-1 flex-row'>
                    <View className='p-4 flex-1'>
                        <Data data={module.documents[selectedModule].sessions} selected={selected} questions={questions} notes={notes}/>
                    </View>
                    {isVertical ?
