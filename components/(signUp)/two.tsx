 ...
 */
const StepTwo = (
    {selectedLanguage, setSelectedLanguage, languages, userData, setUserData,name }:{
    ...
    return (
        <View className='h-full  w-full justify-between items-center py-5'>
                        ...
                        />
                            ...
                            <View>
                                <TouchableOpacity 
                                    ...
                                    >
                                    <CountryFlag isoCode={selectedLanguage == null ? "DE" : languages[selectedLanguage].code} size={18} style={{ width: 30, height: 18 }} />
                                    ...
                                    {isActive ? (
                                        ...
                                        >
                                            <CountryFlag isoCode={language.code} size={18} style={{ width: 30, height: 18 }} />
            ...
            <View className='w-full max-w-[200px] z-0'>
                <GratisPremiumButton active={true} aditionalStyles={"rounded-full w-full bg-blue-500 z-0 "} handlePress={()=> {
