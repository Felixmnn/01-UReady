  ...
  return (
    <View>
        ...
        <View className="flex-row">
            <ContinueBox text={"Erstellen wir zusammen ein Lernset."} colorBorder={"#7a5af8"} colorBG={"#372292"} iconName={"bot"} handlePress={()=> setUserChoices("GENERATE")}/>
            <ContinueBox text={"Mal schauen was deine Komilitonen lernen."} colorBorder={"#20c1e1"} colorBG={"#0d2d3a"} iconName={"search"} handlePress={()=> setUserChoices("DISCOVER")}/>
            <ContinueBox text={"Erstelle dein eigenes Lernset."} colorBorder={"#4f9c19"} colorBG={"#2b5314"} iconName={"cubes"} handlePress={()=> setUserChoices("CREATE")}/>
        </View>
    </View>
  )
}
