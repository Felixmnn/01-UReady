...
import { addQuestionToMMKV, addUnsavedNote, addUnsavedQuestionToMMKV, deleteNoteFromMMKV, getSessionFromMMKV, saveNoteToMMKV, updateUnsavedNote } from './mmkvFunctions';
...
export async function addQUestion(newQuestion){
    ...
    console.log("🟧🟧🟧Adding new Question ",user, user?.$id)
    try {
