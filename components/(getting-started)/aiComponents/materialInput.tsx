...
const MaterialInput = ({
    ...
    setSelectedMaterialType: React.Dispatch<React.SetStateAction<"TOPIC" | "PEN" | "FILE" | "QUESTION">>,
    newitem: {
    ...
    setItems: React.Dispatch<React.SetStateAction<{
        ...
        content: string,
        uri: string | null, 
    sessionID: string; // <-- changed from string | null to string
        id: string | null,
    }[]>>,
    selectedSession: {  
        id: string,
    ...
    <View>
     <View className="flex-row justify-between items-center">
        ...
        <View className="w-full flex-row rounded-full items-center justify-between bg-[#0c111d] border-gray-800 border-[1px] shadow-lg">
            ...
            type="QUESTION"
            handlePress={() => setNewItem({ type: 'QUESTION', content: '', uri: null, sessionID:null, id:null })}
                  ...
                  >
                    {
                      fileList.map((file, index) => {
                        ...
                        <TouchableOpacity key={index}
                                          ...
                                          style={{
                                            backgroundColor: items.some(item => item.id == file.id) ? "#0000ac" : undefined,
                                            height: 73,
                                          }}
                                          onPress={() => {
