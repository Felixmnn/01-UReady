          ...
          <View className="flex-1">
            {loading ? null : (
              <View className="flex-1 items-center ">
                {isVertical ? (
                  <View className="rounded-t-[10px] h-[15px] w-[95%] bg-gray-900 bg-opacity-70  opacity-50"></View>
                ) : null}
                ...
                <View className="flex-1 w-full   bg-gray-900 rounded-[10px] border-gray-700 border-[1px]">
                  <TouchableOpacity
                    ...
                    className="m-2 p-2 flex-row items-center"
                  >
                    <Icon name="arrow-left" size={20} color="white" />
                    <Text className="text-white ml-2 font-bold text-[15px]">
                      {t("editNote.back")}
                    </Text>
                  </TouchableOpacity>
                  <TextInput
