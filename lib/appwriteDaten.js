...
export async function checkAprovedAdd(){
    try {
        const response = await databases.getDocument(
            config.databaseId,
            "aproved",
        ...
        console.log("Aproved Add response:", response);
        ...
        console.log("Error checking aproved add:", error);
        return false;
    }
}