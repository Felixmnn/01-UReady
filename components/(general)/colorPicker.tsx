                            ...
                            <TouchableOpacity
                              ...
                              style={{
                                backgroundColor:
                                  ...
                                  item === "yellow" ? "rgba(202, 138, 4, 0.4)" :
                                  item === "orange" ? "rgba(194, 65, 12, 0.4)" :
                                  item === "purple" ? "rgba(124, 58, 237, 0.4)" :
                                  item === "pink" ? "rgba(219, 39, 119, 0.4)" :
                                  item === "cyan" ? "rgba(8, 145, 178, 0.4)" :
                                  "rgba(31, 41, 55, 0.4)"
                              }}
                            >
                              <View className="items-center justify-center rounded-full" style={{
                                ...
                                {selectedColor == item && selectedColor !== null ? <Icon name="check" size={15} color="white" /> : null}
