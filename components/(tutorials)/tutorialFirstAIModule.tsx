    ...
    >
      ...
      >
        {tutorialStep === 0 ? (
          ...
          <RobotWihtMessage message={t("tutorialFirstModule.youCanCreate")} />
        ) : tutorialStep === 7 ? (
          <RobotWihtMessage message={t("tutorialFirstModule.chooseSession")} />
        ) : tutorialStep === 8 ? (
          <RobotWihtMessage message={t("tutorialFirstModule.thatIsAll")} />
        ) : tutorialStep === 9 ? (
          <RobotWihtMessage
