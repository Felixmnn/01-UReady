        ...
        <View className='h-full  w-full justify-between items-center py-5'>
            ...
            <View className='items-center justiy-center'>
                <View className='w-full max-w-[300px] px-5 h-[75px] bg-gray-900 border-gray-800 border-[1px] rounded-[10px] items-center justify-center z-10'>
                    <Text className='font-semibold text-[15px] text-gray-100 text-center'> Moin! Ich bin Copa. Ich helfe dir dabei, deine App so zu personalisieren, dass du direkt durchstarten kansnt.</Text>
                </View>
