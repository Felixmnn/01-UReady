...
export interface AppwriteUserUsage extends Models.Document {
    streak: number;
    streakActive: boolean;
    streakLastUpdate: string | null;
    energy: number;
...
export interface AppwriteUserKategorie extends Models.Document {
    country: string | null;
    university: string | null;
    region: string | null;
    studiengangZiel: string | null;
...
export interface AppwriteUserData extends Models.Document {
    darkmode: boolean;
    language: string;
    uid:string;
    subscription: string | null;
...
export interface AppwriteQuestion extends Models.Document {
    question: string;
    answers: string[];
    answerIndex: Array<number>;
    public: boolean;
...
export interface AppwriteNote extends Models.Document {
    notiz: string;
    subjectID: string | null;
    sessionID: string | null;
    title: string | null;
...
export interface AppwriteModule extends Models.Document {
    name: string;
    subject: string;
    questions: number;
    notes: number;
...
export interface AppwriteDocumentConfig extends Models.Document {
    title: string;
    sessionID: string;
    subjectID: string;
    databucketID: string;
