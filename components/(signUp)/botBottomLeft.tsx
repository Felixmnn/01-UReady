...
const BotBottomLeft = ({message="", imageSource="Waving", spechBubbleStyle, spBCStyle, isVisible, setIsVisible}) => {
  ...
  return (
    ...
    >
      <TouchableOpacity className="flex-1 justify-end items-center" onPress={() => setIsVisible(false)}>
